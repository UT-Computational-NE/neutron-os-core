...
import subprocess
import sys
from tools.extensions.builtins.mo import acquire_dir
import textwrap
import threading
import time
...
from tools.extensions.builtins.update.background import BackgroundUpdateChecker
from tools.extensions.builtins.update.version_check import VersionInfo
...
class FullScreenChat:
    ...
    def _check_update_manual(self) -> None:
        ...
        try:
            from tools.extensions.builtins.update.version_check import VersionChecker
    ...
    def _perform_update_and_restart(self) -> None:
        ...
        def _do_update():
            try:
                from tools.extensions.builtins.update.cli import Updater
                updater = Updater()
