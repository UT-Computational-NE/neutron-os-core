...
Usage:
    ...
    python -m tools.extensions.builtins.sense.bootstrap

    # Non-interactive (CI/CD)
    python -m tools.extensions.builtins.sense.bootstrap --non-interactive

    # Check prerequisites only
    python -m tools.extensions.builtins.sense.bootstrap --check

    # Specific steps
    python -m tools.extensions.builtins.sense.bootstrap --step k3d
    python -m tools.extensions.builtins.sense.bootstrap --step postgres
    python -m tools.extensions.builtins.sense.bootstrap --step migrate
