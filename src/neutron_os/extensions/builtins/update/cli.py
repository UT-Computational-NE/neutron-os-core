...
class Updater:
    ...
    def _run_migrations(self) -> None:
        ...
        # Run migrations
        try:
            from neutron_os.extensions.builtins.signal_agent.migrations import run_migrations, check_migrations
    ...
    def _check_migrations(self) -> None:
        ...
        try:
            from neutron_os.extensions.builtins.signal_agent.migrations import check_migrations
