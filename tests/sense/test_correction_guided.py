...
class TestGuidedCorrectionReview:
    ...
    def guided_review(self, temp_dirs):
        ...
        from tools.extensions.builtins.sense.correction_review_guided import (
        ...
        with patch.object(
            ...
            import tools.extensions.builtins.sense.correction_review_guided as guided_module
    ...
    def test_extract_audio_clip_no_ffmpeg(self, temp_dirs):
        ...
        from tools.extensions.builtins.sense.correction_review_guided import GuidedCorrectionReview
        
        # Create a real instance for this test
        with patch("tools.extensions.builtins.sense.correction_review_guided.CLIPS_DIR", temp_dirs["clips_dir"]):
            with patch("tools.extensions.builtins.sense.correction_review_guided.REVIEW_STATE_FILE", temp_dirs["corrections_dir"] / "state.json"):
...
class TestCorrectionPropagation:
    ...
    def propagator(self, temp_propagation_dir):
        ...
        from tools.extensions.builtins.sense.correction_propagation import (
        ...
        with patch("tools.extensions.builtins.sense.correction_propagation.PROPAGATION_QUEUE", temp_propagation_dir / "queue.json"):
            with patch("tools.extensions.builtins.sense.correction_propagation.PROPAGATION_LOG", temp_propagation_dir / "log.jsonl"):
                with patch("tools.extensions.builtins.sense.correction_propagation.USER_GLOSSARY", temp_propagation_dir / "glossary.json"):
    ...
    def test_propagate_approval_updates_glossary(self, propagator, temp_propagation_dir):
        ...
        with patch("tools.extensions.builtins.sense.correction_propagation.USER_GLOSSARY", glossary_path):
...
class TestDownstreamUpdates:
    ...
    def test_notification_logged(self, tmp_path):
        ...
        import tools.extensions.builtins.sense.correction_propagation as prop_module
...
class TestPatternMatching:
    ...
    def system_with_patterns(self, tmp_path):
        ...
        from tools.extensions.builtins.sense.correction_review import CorrectionReviewSystem
