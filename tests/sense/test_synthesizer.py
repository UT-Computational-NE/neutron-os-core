...
from tools.extensions.builtins.sense.models import Signal, Changelog
...
class TestStrategicOrdering:
    ...
    def test_higher_weight_first(self, tmp_path):
        ...
        from tools.extensions.builtins.sense.correlator import Correlator, Initiative
...
class TestWeeklySummaryAnnotations:
    ...
    def test_blocker_section_in_summary(self, tmp_path):
        ...
        from tools.extensions.builtins.sense.blocker_tracker import BlockerTracker
