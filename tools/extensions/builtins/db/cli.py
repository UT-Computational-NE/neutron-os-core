...
def cmd_down(args: argparse.Namespace) -> int:
    ...
    from tools.extensions.builtins.sense.pgvector_store import k3d_down
...
def cmd_delete(args: argparse.Namespace) -> int:
    ...
    from tools.extensions.builtins.sense.pgvector_store import k3d_delete
...
def cmd_status(args: argparse.Namespace) -> int:
    ...
    from tools.extensions.builtins.sense.pgvector_store import k3d_status, VectorDB
...
def cmd_migrate(args: argparse.Namespace) -> int:
    ...
    from tools.extensions.builtins.sense.migrations import (
        run_migrations,
        check_migrations,
        verify_schema,
...
def cmd_bootstrap(args: argparse.Namespace) -> int:
    ...
    from tools.extensions.builtins.sense.bootstrap import Bootstrap, BootstrapConfig, BootstrapStep
