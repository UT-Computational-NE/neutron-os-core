...
class TestCorrectorIdGeneration:
    ...
    def test_corrector_generates_deterministic_ids(self):
        ...
        from neutron_os.extensions.builtins.signal_agent.corrector import TranscriptCorrector, Correction, CorrectionResult
        ...
        with patch("neutron_os.extensions.builtins.signal_agent.correction_review.CorrectionReviewSystem") as MockReview:
