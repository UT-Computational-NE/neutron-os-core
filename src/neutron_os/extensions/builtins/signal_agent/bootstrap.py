...
Usage:
    ...
    python -m tools.extensions.builtins.signal_agent.bootstrap

    # Non-interactive (CI/CD)
    python -m tools.extensions.builtins.signal_agent.bootstrap --non-interactive

    # Check prerequisites only
    python -m tools.extensions.builtins.signal_agent.bootstrap --check

    # Specific steps
    python -m tools.extensions.builtins.signal_agent.bootstrap --step k3d
    python -m tools.extensions.builtins.signal_agent.bootstrap --step postgres
    python -m tools.extensions.builtins.signal_agent.bootstrap --step migrate
