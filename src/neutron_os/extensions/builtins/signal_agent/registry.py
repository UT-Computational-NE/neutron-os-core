...
Usage:
    from neutron_os.extensions.builtins.signal_agent.registry import get_registry
...
class SignalRegistry:
    ...
    def _discover_extractors(self) -> None:
        ...
        try:
            from neutron_os.extensions.builtins.signal_agent import extractors
            ...
            for importer, modname, ispkg in pkgutil.iter_modules(extractors.__path__):
                ...
                try:
                    module = importlib.import_module(
                        f"neutron_os.extensions.builtins.signal_agent.extractors.{modname}"
                    )
