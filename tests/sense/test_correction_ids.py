...
class TestCorrectorIdGeneration:
    ...
    def test_corrector_generates_deterministic_ids(self):
        ...
        from tools.extensions.builtins.sense.corrector import TranscriptCorrector, Correction, CorrectionResult
        ...
        with patch("tools.extensions.builtins.sense.correction_review.CorrectionReviewSystem") as MockReview:
