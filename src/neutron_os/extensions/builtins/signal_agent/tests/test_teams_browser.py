...
class TestTeamsBrowserExtractor:
    ...
    def test_name(self):
        from neutron_os.extensions.builtins.signal_agent.extractors.teams_browser import (
    ...
    def test_extract_processes_downloaded_files(self, tmp_path: Path):
        ...
        with mock.patch.object(ext, "fetch_transcripts", return_value=[transcript]):
            with mock.patch(
                "neutron_os.extensions.builtins.signal_agent.extractors.transcript.TranscriptExtractor"
            ) as MockTranscript:
    ...
    def test_registered_as_source(self):
        ...
        import neutron_os.extensions.builtins.signal_agent.extractors.teams_browser as mod
...
class TestTeamsBrowserRegistration:
    ...
    def test_import_does_not_fail(self):
        ...
        from neutron_os.extensions.builtins.signal_agent.extractors import teams_browser  # noqa: F401
