...
def _check_restart_state() -> Optional[dict]:
    ...
    try:
        from tools.extensions.builtins.update.version_check import read_restart_state
...
def _clear_restart_state() -> None:
    ...
    try:
        from tools.extensions.builtins.update.version_check import clear_restart_state
        clear_restart_state()
    except Exception:
        pass
