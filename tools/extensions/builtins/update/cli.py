...
class Updater:
    ...
    def _run_migrations(self) -> None:
        ...
        # Run migrations
        try:
            from tools.extensions.builtins.sense.migrations import run_migrations, check_migrations
    ...
    def _check_migrations(self) -> None:
        ...
        try:
            from tools.extensions.builtins.sense.migrations import check_migrations
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.status:
        print("\n")
        from tools.extensions.builtins.status.cli import HealthChecker, format_health_table
