...
Usage:
    from tools.extensions.builtins.sense.registry import get_registry
...
class SignalRegistry:
    ...
    def _discover_extractors(self) -> None:
        ...
        try:
            from tools.extensions.builtins.sense import extractors
            ...
            for importer, modname, ispkg in pkgutil.iter_modules(extractors.__path__):
                ...
                try:
                    module = importlib.import_module(
                        f"tools.extensions.builtins.sense.extractors.{modname}"
                    )
